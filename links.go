...
func init() {
	...
	registerLinkCommand("discord", "Link naar Discord", "Nog een beetje in de war over hoe Discord werkt?: https://support.discordapp.com/hc/nl")
	...
	registerLinkCommand("bot", "Link naar de git repo", "Biep Boep, bekijk zeker mijn git repo https://github.com/itfactory-tm/thomas-bot ")
